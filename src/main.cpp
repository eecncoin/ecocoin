...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in EcoCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // EcoCoin: check proof-of-stake block signature
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "ECO Genesis";
        CTransaction txNew;
        txNew.nTime = 1471482403;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1471482409;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2886947; // !fTestNet ? 1575379 : 46534;
		
       
        block.print();

        //// debug print
        assert(block.hashMerkleRoot == uint256("0x31a6f398f1fac78409203a5aad5698dff7fbea904ddb2feb514eaf5e416c7f94"));
...
unsigned char pchMessageStart[4] = { 0xc4, 0xe8, 0xe5, 0xa5 };
