...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\EcoCoinData
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\EcoCoinData
    // Mac: ~/Library/Application Support/EcoCoinData
    // Unix: ~/.EcoCoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "EcoCoinData";
#else
    fs::path pathRet;
