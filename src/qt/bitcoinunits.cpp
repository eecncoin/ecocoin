...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("EECN");
    case mBTC: return QString("mEECN");
    case uBTC: return QString::fromUtf8("μEECN");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("EcoCoins"));
    case mBTC: return QString(QObject::tr("Milli-EcoCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-EcoCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
